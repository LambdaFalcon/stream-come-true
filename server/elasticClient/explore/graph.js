 ...
 * @property {Array<{field: string, size: number, min_doc_count: number}>} vertices
 * @property {{vertices: Array<{field: string, size: number, min_doc_count: number}> }} conenctions
 *
 *
